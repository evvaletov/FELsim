...
3. **Local-gamma law:** the frozen SC defocus dpx/x falls from 1.07e+01 1/m at 1 MeV to 4.42e-04 1/m at 41.5 MeV (**x24265**), tracking the 1/(beta gamma)^3 relativistic shielding (predicted x25782). A single fixed-energy SC block would apply the 1 MeV strength throughout and over-estimate SC by this factor.
