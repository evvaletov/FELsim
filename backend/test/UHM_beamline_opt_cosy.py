...
Translates the 11-stage FELsim optimization (UHM_beamline_opt_v2.py) into
COSY's internal FIT command. Supports S1 (2 ps) and S3 (0.5 ps) configs,
multistart for Stage 5, and full 11-stage optimization in a single COSY run.

Phase 0b–2 of W4: COSY INFINITY Full Beamline Optimisation.
