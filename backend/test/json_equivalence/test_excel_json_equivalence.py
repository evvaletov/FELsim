...
def main():
    ...
    tests = [
        ...
        ("v2_round_trip", test_v2_round_trip),
        ("v3_round_trip", test_v3_round_trip),
        ("v3_schema_validation", test_v3_schema_validation),
        ("v3_bn1_values", test_v3_bn1_values),
        ("v3_bendp_g_ref", test_v3_bendp_g_ref),
        ("v3_bendp_edge_angles", test_v3_bendp_edge_angles),
        ("v1_backward_compat", test_v1_backward_compat),
        ("kind_only_elements", test_kind_only_elements),
        ("kind_only_inline", test_kind_only_inline),
    ]
