...
class TestPartA_COSY:
    ...
    def test_transfer_map(self, v3_json_path):
    ...
    def test_twiss_from_map(self, v3_json_path):
...
class TestPartB_CrossCode:
    ...
    def test_felsim_vs_cosy_twiss(self, v3_json_path, felsim_particles):
    ...
    def test_all_three_stable(self, v3_json_path, felsim_particles):
        ...
        print("\n╔══════════════════════════════════════════════════════════╗")
        print("║       3-Way Simulation QA via v3 JSON                   ║")
        print("╠══════════════════════════════════════════════════════════╣")
        for plane in ('x', 'y'):
            beta_f = _get_twiss(tw_f, plane, 'beta')
            ...
            print(f"║  {plane}-plane:")
            print(f"║    FELsim   β={beta_f:10.4f} m  α={alpha_f:10.4f}")
            print(f"║    RF-Track β={beta_r:10.4f} m  α={alpha_r:10.4f}")
            print(f"║    COSY     β={beta_c:10.4f} m  α={alpha_c:10.4f}")
